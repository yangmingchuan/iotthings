 ...
 * 代码自动生成
 *
 * package name: com.ymc.iotthings
 * date :2019/5/28
 * author : ymc
 **/
...
public class CodeGenerator {
    ...
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/demo?serverTimezone=GMT%2B8";
    ...
    // @author
    private static final String AUTHOR = "ymc";
    // @date
